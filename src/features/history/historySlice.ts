...
function ensureSavedShape(e: any) {
  ...
  // ✅ compat: si venía del formato antiguo (saved.mp3/srt/wav), lo migramos a v1
  if ((e.saved.mp3 || e.saved.srt || e.saved.wav) && !e.saved.__migratedV) {
    if (e.saved.mp3 && !e.saved.v1.mp3) e.saved.v1.mp3 = e.saved.mp3;
    if (e.saved.srt && !e.saved.v1.srt) e.saved.v1.srt = e.saved.srt;
    if (e.saved.wav && !e.saved.v1.wav) e.saved.v1.wav = e.saved.wav;
